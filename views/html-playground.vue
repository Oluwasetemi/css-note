      ...
      <div class="flex flex-col w-1/2 overflow-hidden">
        ...
        <div class="flex flex-col h-[180px] bg-[#1e1e1e]">
          <div class="flex items-center justify-between px-3 py-1 bg-[#2d2d2d] border-b border-[#444] flex-shrink-0">
            ...
            <button
              class="text-xs text-[#888] hover:text-[#ccc] cursor-pointer bg-transparent border-none"
              @click="clearConsole"
            >
              Clear
            </button>
          ...
          <div class="flex-1 overflow-y-auto p-3 text-xs font-mono">
            <div
              v-for="(log, i) in logs"
              :key="i"
              class="mb-1 pb-1 border-b border-[#333] flex gap-2"
            >
              <span
                :class="{
                  'text-[#60a5fa]': log.type === 'log',
                  'text-[#fbbf24]': log.type === 'warn',
